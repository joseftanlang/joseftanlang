...
.banner{
    ...
    radial-gradient(circle at 80% 80%, rgba(0,245,255,.15), transparent 35%),
...
.hero h1{
    ...
    background:linear-gradient(90deg,#fff,#00f5ff,#7c3aed);
    -webkit-background-clip:text;
    -webkit-text-fill-color:transparent;

    filter:drop-shadow(0 0 25px rgba(0,245,255,.3));
}
...
<div class="subtitle">
    Building <span class="highlight">products</span>,
    scalable products for real life porjects.
</div>
...
<div class="particle" style="left:10%;bottom:-10px"></div>
<div class="particle" style="left:25%;bottom:-10px;animation-delay:2s"></div>
<div class="particle" style="left:50%;bottom:-10px;animation-delay:4s"></div>
...
- Developing **embedded systems** with C and C++
- Building **responsive web apps** using HTML, CSS, JavaScript, Angular and React
- Exploring **cloud computing** (AWS, GCP, Azure)
...
- Developing an **AI-powered HR Management System**
- IoT projects and smart devices
- Web app innovations and APIs
...
<!-- ![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=joseftanlang&layout=compact&theme=github_dark&hide_border=true&bg_color=0d1117) -->

[![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=joseftanlang&theme=github-dark-blue&hide_border=true&background=0d1117)](https://git.io/streak-stats)

<img src="https://github-readme-activity-graph.vercel.app/graph?username=joseftanlang&radius=16&theme=github&area=true&order=5" height="300" alt="activity-graph" />
...
**I love meeting new people and collaborating on exciting projects!** Whether it’s brainstorming ideas or coding late into the night, I believe that teamwork fuels innovation. Let’s do something amazing together!